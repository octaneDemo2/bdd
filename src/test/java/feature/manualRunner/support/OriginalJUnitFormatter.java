...
public class OriginalJUnitFormatter implements Formatter, Reporter, StrictAware {
    ...
    public OriginalJUnitFormatter(URL out) throws IOException {
    ...
    public void done() {
        try {
            ...
            rootElement.setAttribute("name", OriginalJUnitFormatter.class.getName());
